        ...
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/office2.jpg');">
                <div class="wrap-login100">
                    <form class="form-container" method="post" action="staffRegistration2.jsp" name="staff_registration_form" id="staff_registration_form">
                        ...
                        <div class="login100-form">
                          ...
                          <input type="text" class="input100" name="staffId" id="staffId" placeholder="StaffId" pattern="[A-Z]+[A-Z]+[0-9]{5,5}" title="2 or 3 capital letters followed by 5 numbers" minlength="7" maxlength="8" required>
                        </div>
                        <div class="login100-form">
