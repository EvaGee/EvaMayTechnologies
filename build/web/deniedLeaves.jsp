<%-- 
    Document   : deniedLeaves
    Created on : Dec 17, 2020, 11:00:19 AM
    Author     : user
--%>
...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-brand-text accordion" id="accordionSidebar">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-white">Denied Leaves</h2>
      <!-- Icon Divider -->
                ...
                <tbody>
                   <%
                       Connection con;
                        ...
                        st = con.prepareStatement("select * from leaves where staffId=? && status='declined'");
