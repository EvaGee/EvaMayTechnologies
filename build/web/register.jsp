<%-- 
    Document   : register
    Created on : Dec 1, 2020, 10:04:58 PM
    Author     : user
--%>
        ...
        <div class="limiter">
            <div class="container-login100" style="background-image: url('images/office2.jpg');">
                <div class="wrap-login100">
                    <form class="form-container" method="post" action="AddInterviewerServlet" name="registration_form" id="registration_form">
                        ...
                        <div class="login100-form">
                          ...
                          <input type="password" class="input100" id="password" name="password" placeholder="password" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$" title="at least 8 characters, 1 uppercase, 1 number, 1 lowercase and 1 special character" required>
                        </div>
                        <div class="login100-form">
                          <label for="lname">Confirm Password:</label>
                          <input type="password" class="input100" id="cpassword" name="cpassword" placeholder="Confirm password" required>
                        </div>
                       
                         <br>
                        <center>
                            <button type="submit" class="login100-form-btn" onclick="validateForm()">Register</button>
                        </center>
                    </form>
                    <br>
                        <center>
