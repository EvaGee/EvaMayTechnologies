...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <form class=\"form-container\" method=\"post\" action=\"AddInterviewerServlet\" name=\"staff_registration_form\" id=\"staff_registration_form\" enctype=\"multipart/form-data\">\n");
      ...
      out.write("                          <input type=\"password\" class=\"input100\" id=\"password\" name=\"password\" placeholder=\"password\" pattern=\"^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$\" title=\"at least 8 characters, 1 uppercase, 1 number, 1 lowercase and 1 special character\" required>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"login100-form\">\n");
      out.write("                          <label for=\"lname\">Confirm Password:</label>\n");
      out.write("                          <input type=\"password\" class=\"input100\" id=\"cpassword\" name=\"cpassword\" placeholder=\"Confirm password\" required>\n");
      out.write("                        </div>\n");
      out.write("                        <div class=\"login100-form\">\n");
      out.write("                          <label for=\"resume\">Resume:</label>\n");
      out.write("                          <input type=\"file\" name=\"resume\" required>\n");
      out.write("                        </div>\n");
      out.write("                         <br>\n");
      out.write("                        <center>\n");
      out.write("                            <button type=\"submit\" class=\"login100-form-btn\" onclick=\"validateForm()\">Register</button>\n");
      out.write("                        </center>\n");
      out.write("                    </form>\n");
      out.write("                    <br>\n");
      out.write("                        <center>\n");
      ...
      out.write("                            { \n");
      out.write("                                \n");
      out.write("                                var cpassword = document.forms[\"staff_registration_form\"][\"cpassword\"];\n");
      out.write("                                var password = document.forms[\"staff_registration_form\"][\"password\"];\n");
      out.write("\n");
      out.write("                                \n");
      out.write("                                if (password.value != cpassword.value) \n");
      out.write("                                {\n");
      out.write("\n");
