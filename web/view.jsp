<%-- 
    Document   : view
    Created on : Dec 17, 2020, 3:39:30 PM
    Author     : user
--%>
...
<body id="page-top">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-brand-text accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="viewApplicants.jsp">View Applicants</a>
     ...
     <div id="content-wrapper" class="d-flex flex-column">
      ...
      <h2 class="page-section-heading text-center text-uppercase text-white">Applied Jobs</h2>
      <!-- Icon Divider -->
