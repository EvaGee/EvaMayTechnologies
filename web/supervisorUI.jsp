<%-- 
    Document   : supervisorUI
    Created on : Feb 25, 2020, 12:47:58 PM
    Author     : Eva
--%>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
             <a class="collapse-item" href="appliedLeaves.jsp">Applied Leaves</a>  
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${staff.fname} ${staff.mname} ${staff.lname}</p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
        ...
        <div class="col-lg-4 mr-auto">
          <p class="lead">${staff.department} </p>
        </div>
      </div>
        <div class="row">
        <div class="col-lg-4 ml-auto">
