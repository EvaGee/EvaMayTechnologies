<%-- 
    Document   : managerLeaves
    Created on : Oct 29, 2020, 10:11:18 PM
    Author     : user
--%>
                ...
                <tbody>
                   <%
                       Connection con;
                        ...
                        st = con.prepareStatement("SELECT * FROM leaves JOIN staffdetails USING (staffId) WHERE staffdetails.department=? && leaves.status='allowed'");
